      ...
      <AuthLayout>
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-neutral-500">
            We sent a confirmation link to <strong className="text-neutral-900">{email}</strong>. Click it to activate your account, then log in.
          </p>
          <Link
            href="/login"
            className="mt-6 inline-block w-full rounded-lg bg-neutral-900 py-3 text-center text-sm font-medium text-white transition-colors hover:bg-neutral-800"
          >
            Go to log in
          </Link>
        </div>
